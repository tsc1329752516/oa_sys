...
<form class="layui-form linksAdd">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="description" value="" class="layui-input" lay-verify="required" placeholder="请输入机构的描述信息" />
        </div>
    </div>
    <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['form','layer','jquery','treeSelect'],function(){
        ...
        treeSelect.render({
            ...
            elem: '#tree',
            // 数据
            data: path + '/department/treeSelectDataJson?id=0',
